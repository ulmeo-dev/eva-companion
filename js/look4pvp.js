    ...
    selected && !loadingSessions && filteredSessions.length > 0 && React.createElement("div", null,
      filteredSessions.map(function(s, i) {
        ...
        return React.createElement("div", {
          ...
          // Time + pricing dot
          React.createElement("div", { style: { minWidth:42, textAlign:"center", flexShrink:0 } },
            React.createElement("div", { style: { fontSize:15, fontWeight:700, color:P.accent, fontFamily:F.mono } }, time),
            React.createElement("div", { style: { fontSize:10, marginTop:2 } }, priceDot)
          ),
          ...
          React.createElement("div", { style: { flex:1, minWidth:0 } },
            ...
            hasPeople && s.matchmakingLevel && React.createElement("div", { style: { fontSize:11, color:P.textSec, fontFamily:F.mono } }, s.matchmakingLevel)
          ),
